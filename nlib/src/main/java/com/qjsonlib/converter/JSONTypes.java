...
class JSONTypes {
	...
	static Type getSupertype(Type context, Class<?> contextRawType,
							 Class<?> supertype) {
	...
	public static Type resolve(Type context, Class<?> contextRawType,
		...
		while (true) {
			if (toResolve instanceof TypeVariable) {
			...
			} else if (toResolve instanceof Class
					&& ((Class<?>) toResolve).isArray()) {
				Class<?> original = (Class<?>) toResolve;
				Type componentType = original.getComponentType();
				Type newComponentType = resolve(context, contextRawType,
						componentType);
				...
				if (originalLowerBound.length == 1) {
					Type lowerBound = resolve(context, contextRawType,
							originalLowerBound[0]);
					if (lowerBound != originalLowerBound[0]) {
						return supertypeOf(lowerBound);
					}
				} else if (originalUpperBound.length == 1) {
					Type upperBound = resolve(context, contextRawType,
	...
	private static final class ParameterizedTypeImpl implements
		...
		public boolean equals(Object other) {
			return other instanceof ParameterizedType
					&& JSONTypes.equals(this, (ParameterizedType) other);
		}
	...
	private static final class GenericArrayTypeImpl implements
		...
		public boolean equals(Object o) {
			return o instanceof GenericArrayType
					&& JSONTypes.equals(this, (GenericArrayType) o);
		}
	...
	private static final class WildcardTypeImpl implements WildcardType,
		...
		public boolean equals(Object other) {
			return other instanceof WildcardType
					&& JSONTypes.equals(this, (WildcardType) other);
		}
