 ...
 */
public class QGuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public QGuideView(Context context) {
        super(context);
