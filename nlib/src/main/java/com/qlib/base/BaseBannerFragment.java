...
//有横幅滚动的界面使用
public class BaseBannerFragment extends BaseFragment implements QInterface,
		OnClickListener {
	...
	public void InitComponents() {
		...
		int tpwt2 = (int) ((tpwt / 3) * 2);
		mViewPager.setLayoutParams(new FrameLayout.LayoutParams(tpwt, tpwt2));
	...
	public void setBannerLayoutParams() {
		mViewPager.setLayoutParams(new FrameLayout.LayoutParams(QUtils
				.getScreenWitdh(act_instance), (int) (QUtils
				.getScreenWitdh(act_instance) / 2)));
	}
